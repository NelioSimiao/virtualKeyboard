const Keyboard = {
    ...
    init() {
        ...
        //Automatically use keyboard for elements with .use__keyboard-input
    ...
    _createKeys(){
        ...
        keyLayout.forEach(key=>{
            ...
            const insertLineBreak=["backspace","p","enter","p"].indexOf(key)!== -1;
           ...
           // add attributes/classes
            ...
            switch(key){
                case "backspace" :
                    ...
                    case "caps" :
                    keyElement.classList.add("keyboard__key__wide","keyboard__key__activatable");
                    ...
                    case "space" :
                            keyElement.classList.add("keyboard__key__extra__wide");
                    ...
                    case "done" :
                            keyElement.classList.add("keyboard__key__wide","keyboard__key__dark");
...
window.addEventListener("DOMContentLoaded",function(){
    Keyboard.init();
    Keyboard.open("aqui",function(currentValue){
